...
/** Represents a boolean field over face loci. */
public class BoolF extends BoolFieldS {
    ...
    /** Creates a new BoolF. */
    public BoolF() { super(HEIGHT, SPAN, BREADTH); }
    ...
    public static HashMap<Face, Boolean> decode(HashSet<Face> faces, BoolF field) {
        ...
        for (Face f : faces)
            res.put(f, getBit(field, f.y, f.x, f.t));
        return res;
    }
