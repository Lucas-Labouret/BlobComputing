...
public class BoolFe extends BoolFieldT {
    ...
    public static BoolF redOrF(BoolFe orig){
        BoolFe maskedData = maskData(DATA_POS, orig, BoolFe.zeroes());
    ...
    public static BoolF redAndF(BoolFe orig){
        BoolFe maskedData = maskData(DATA_POS, orig, BoolFe.ones());
