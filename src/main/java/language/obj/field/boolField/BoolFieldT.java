...
public abstract class BoolFieldT extends BoolField {
    /** Creates a new transfer boolean language.obj.field base instance. */
    ...
    /** Copies broadcast data into the corresponding transfer language.obj.field. */
    ...
    /** Computes the OR reduction for the target simplicial language.obj.field. */
    ...
    /** Computes the AND reduction for the target simplicial language.obj.field. */
    ...
    /** Computes the XOR reduction for the target simplicial language.obj.field. */
    ...
    /** Applies the transfer mask to the target language.obj.field. */
