...
public abstract class IntField<F extends BoolField> extends Obj {
    ...
    static <F extends BoolField, R extends Ref<F>> void transpose(R[][] in, R[][] out, int n, int N) {
    ...
    public static Procedure redAdd(IntVeRef intVe, IntVRef intV) { return new IntRedAddVe(intVe, intV); }
    public static Procedure redAdd(IntVfRef intVf, IntVRef intV) { return new IntRedAddVf(intVf, intV); }
